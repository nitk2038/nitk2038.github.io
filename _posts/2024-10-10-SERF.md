...
- 그러나, 기존 RDBMS 기반 Filtering과 벡터 탐색을 동시에 수행하는 것은 여전히 컴퓨터과학에서 도전적인 분야
...
- Range-Filtering ANNS(Approximate Nearest Neighbor Search)는 query range와 query vector로 구성됨
